...
$PRESERME_METADATA = $true     # Keep EXIF/GPS data by default
$KEEP_ORIGINAL = $false        # Now replaces originals by default
...
Write-Host "$SUCCESS All optimizations complete! Original files were replaced."
